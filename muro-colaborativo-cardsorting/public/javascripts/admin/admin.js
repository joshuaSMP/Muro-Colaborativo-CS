    ...
    success: function (res) {
      ...
      for (var i = 0; i < res.forums.length; i++) {
        ...
        var element = '<li id="' + foro.id_foro + 'listElement">' +
          ...
          // Ajusta el estilo para títulos largos, permitiendo el salto de línea. Se cambia a display:block para que funcione.
          '<h3 style="display: block; word-wrap: break-word; max-width: 20ch; margin: 0 auto;' + (foro.tema_foro.length > 6 ? 'style="text-align:center; padding:5px; font: 1.5vw;' : '') + '">' + foro.tema_foro + '</h3>' +
          '<div class="dropdown">' +
